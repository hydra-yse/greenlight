...
pub fn decode_request(uri: &str, p: &[u8]) -> anyhow::Result<Request> {
    Ok(match uri {
        ...
        "/cln.Node/AutoCleanInvoice" => {
            Request::AutoCleanInvoice(AutocleaninvoiceRequest::decode(p)?)
        }
        ...
        "/cln.Node/DelExpiredInvoice" => {
            Request::DelExpiredInvoice(DelexpiredinvoiceRequest::decode(p)?)
        }
        ...
        "/cln.Node/Offer" => Request::Offer(OfferRequest::decode(p)?),
